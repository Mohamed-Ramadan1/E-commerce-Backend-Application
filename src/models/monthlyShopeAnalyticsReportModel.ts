...
import { IMonthlyShopAnalyticsReport } from "./monthlyShopeAnalyticsReport.interface";

const monthlyShopAnalyticsReportSchema: Schema =
  new Schema<IMonthlyShopAnalyticsReport>(
    {
...
const MonthlyShopAnalyticsReportModel: Model<IMonthlyShopAnalyticsReport> =
  model<IMonthlyShopAnalyticsReport>(
    "MonthlyShopAnalyticsReport",
    monthlyShopAnalyticsReportSchema
  );

export default MonthlyShopAnalyticsReportModel;
