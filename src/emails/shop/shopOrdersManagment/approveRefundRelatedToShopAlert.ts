...
const rejectRefundRelatedToShopAlert = (
  ...
  const mailOptions = {
    ...
    to: shop.email,
    subject: "Refund request related to your shop has been approved",
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="font-family: 'Helvetica Neue', Arial, sans-serif; color: #333; line-height: 1.6; font-size: 16px; background-color: #f0f4f8; padding: 20px 0; margin: 0;">
        ...
        <div style="background-color: #ebf5fb; border-radius: 8px; padding: 20px; margin: 20px 0;">
            ...
            <table style="width: 100%; border-collapse: separate; border-spacing: 0 10px;">
                ...
                <tr>
                    ...
                    <td style="padding: 5px 10px; color: #2980b9; font-weight: bold;">${
                ...
                <tr>
                    ...
                    <td style="padding: 5px 10px;">$${shop.balance.toFixed(
                      2
                    )}</td>
                </tr>
            </table>
  ...
  transport.sendMail(mailOptions, (err: Error | null, info: any) => {
    if (err) {
      ...
      console.log("Refund  request approve email  sent to  shop .");
    }
  });
};
